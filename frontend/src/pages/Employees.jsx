...
export default function Employees() {
  ...
  const [form, setForm] = useState({ employeeCode: '', name: '', email: '', phone: '', department: '', designation: '', location: '', gender: '', employeeType: 'Full-time' });
  ...
  async function createEmployee(e) {
    ...
    setForm({ employeeCode: '', name: '', email: '', phone: '', department: '', designation: '', location: '', gender: '', employeeType: 'Full-time' });
    setShowForm(false);
    load();
  }
