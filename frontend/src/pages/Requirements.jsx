  ...
  return (
    <div>
      ...
      <div className="tbl-wrap">
        <table>
          <thead>
            <tr><th>Title</th><th>Client</th><th>Priority</th><th>Status</th><th>Applications</th><th></th></tr>
          </thead>
          <tbody>
            {requirements.map((r) => (
              <tr key={r.id} className="row-link">
                ...
                <td><button className="btn btn-sm btn-ghost" onClick={() => toggleStatus(r.id)}>{r.status === 'OPEN' ? 'Close' : 'Reopen'}</button></td>
              </tr>
            ))}
