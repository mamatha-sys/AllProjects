// Financial-year-aware period resolution shared by the Accounts Dashboard and
// Work (Invoices) pages — mirrors the reference app's fyPicker: Current FY /
// Previous FY / Quarter / Half Year / Custom Date / All time.
...
function resolvePeriod({ mode, fy, q, h, from, to } = {}) {
  const now = new Date();
...
module.exports = { resolvePeriod, inRange, fyStartYear, fyLabel, QUARTERS, HALVES };
